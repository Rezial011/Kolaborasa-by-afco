  ...
  return (
    <>
      ...
      <section className="bg relative overflow-hidden">
        <div
          className="absolute top-[1.8%] -right-70 sm:top-[1.5%] sm:-right-80 md:top-[1%] md:-right-80 xl:-right-60 lg:top-[0.8%] h-auto w-auto"
          data-aos="fade-left"
          data-aos-delay="600"
        >
          <svg
            className="opacity-5  h-auto sm:w-190 lg:w-180"
