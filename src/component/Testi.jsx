    ...
    >
      <div className="flex w-max gap-8 px-10 md:px-0 py-5">
        {testimoni.map((testi) => (
          ...
          >
            <p
              className={`italic mb-7 leading-6  ${
                clicked === testi.id ? "line-clamp-none" : "line-clamp-8"
              }`}
              onClick={() => click(testi.id)}
            >
              "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odit
              delectus minima porro, dignissimos veritatis nulla, quis
              voluptatibus eos debitis possimus et quia vitae quisquam incidunt
              sint repudiandae sunt! Consequuntur, assumenda!"
            </p>
            <div className="flex items-center gap-5">
              ...
              />
              <div>
                <h1 className="text-[#333333] font-semibold line-clamp-2">
                  Lorem Ipsum
                </h1>
                <h2 className="text-xs line-clamp-1 font-bold">Lorem Ipsum</h2>
              </div>
            </div>
          </div>
        ))}
