    ...
    <>
      <section className="past-events-section" id="events">
        <div className="section-title">
          <h2 className="main-title font-semibold" data-aos="fade-up">
            Our Past Events
          </h2>
          ...
          {eventsData.map((event, index) => (
            <div key={event.id} data-aos="fade-up" data-aos-delay={index * 100}>
              <div className="event-card group ">
                ...
                <div className="event-details border-solid border-3 border-[#363636] rounded-b-2xl border-t-transparent">
