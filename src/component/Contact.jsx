...
_Pesan dikirim melalui form kontak website_`;
  ...
  const copyAndOpenWhatsApp = () => {
    ...
    navigator.clipboard
      ...
      .then(() => {
        alert(
          "Pesan berhasil disalin! Anda akan dialihkan ke WhatsApp. Silakan paste pesan di chat."
        );
  ...
  return (
    <>
      <section className="contact" id="contact">
            ...
            <div className="contact-detail">
              ...
              <div className="contact-text">
                ...
                <p>
                  ...
                  >
                    Kota Wisata Cibubur, Jl. Pesona Amerika No.A2 No. 20,
                    Ciangsana, Kec. Gn. Putri, Kabupaten Bogor, Jawa Barat 16967
                  </a>
                </p>
              </div>
            </div>
        ...
        <svg className="absolute -bottom-28 left-5 opacity-5 md:left-10 lg:left-23 lg:scale-130"
          xmlns="http://www.w3.org/2000/svg"
          width="180"
          height="180"
          viewBox="0 0 24 24"
